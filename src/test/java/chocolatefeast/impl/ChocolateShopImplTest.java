...
public class ChocolateShopImplTest {
    ...
    private int countOfChocolatesOfType(List<Chocolate> chocolates, ChocolateType chocolateType) {
        int count = 0;
    ...
    private int countOfChocolatesOfState(List<Chocolate> chocolates, ChocolateState chocolateState) {
        int count = 0;
        for (Chocolate chocolate : chocolates) {
